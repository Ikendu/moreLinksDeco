      ...
      <div className="chooseUs">
        ...
        <div className="imageDetails">
          <div className="pageContent">
            ...
            <p>
              ...
              our team works closely with you to craft unique designs that speak
              to your personality and purpose.
            </p>
          </div>
        ...
        <div className="imageDetails2">
          <div className="pageContent">
            ...
            <p>
              From the smallest centerpiece to the grandest backdrops, every
              detail matters. We obsess over every element to ensure your event
              looks flawless, creating a seamless ambiance that wows your
              guests.
            </p>
          </div>
        ...
        <div className="imageDetails">
          <div className="pageContent">
            ...
            <p>
              Our creative team stays ahead of trends, blending modern
              aesthetics with timeless elegance. We don’t just decorate; we
        ...
        <div className="imageDetails">
          <div className="pageContent">
            ...
            <p>
              Whether you’re dreaming of a lavish wedding, a chic corporate
              event, or an intimate celebration, we’ll bring your unique vision
              to life.
            </p>
          </div>
        ...
        <div className="imageDetails2">
          <div className="pageContent">
            ...
            <p>
              Your events are more than just dates on a calendar—they’re
              milestones, memories, and moments that deserve to be celebrated in
              style. we bring your dreams to life with stunning event décor
